...
Future<void> createPdf(Ticket ticket, final key) async {
  ...
  page.graphics
      .drawRectangle(bounds: const Rect.fromLTWH(0, 30, 400, 1), brush: brush2);
  ...
  page.graphics.drawString(
    ...
    bounds: Rect.fromLTWH(infoX, infoY, infoWidth, infoHeight),
  );
  page.graphics.drawString(
    'Room: ${ticket.roomName}',
    PdfStandardFont(PdfFontFamily.helvetica, 12),
    bounds: Rect.fromLTWH(infoX, infoY + 35, infoWidth, infoHeight),
  );
  page.graphics.drawString(
    'Row: ${ticket.rowIndex}',
    PdfStandardFont(PdfFontFamily.helvetica, 12),
    bounds: Rect.fromLTWH(infoX, infoY + 60, infoWidth, infoHeight),
  );
  page.graphics.drawString(
    'Place: ${ticket.seatIndex}',
    PdfStandardFont(PdfFontFamily.helvetica, 12),
    bounds: Rect.fromLTWH(infoX, infoY + 85, infoWidth, infoHeight),
  );
  page.graphics.drawString(
    ...
    PdfStandardFont(PdfFontFamily.helvetica, 12),
    bounds: Rect.fromLTWH(infoX, infoY + 110, infoWidth, infoHeight),
  );
  page.graphics.drawString(
    'Scan QR',
    PdfStandardFont(PdfFontFamily.helvetica, 12),
    bounds: Rect.fromLTWH(infoX - 30, infoY + 160, infoWidth, infoHeight),
  );
  ...
  page.graphics.drawImage(
      qrImage, const Rect.fromLTWH(imageX + 50, imageY + 160, 200, 150));
